  ...
  const quickActions = useMemo(() => [
    {
      ...
      subtitle: `${focusMinutesThisWeek} ${t('dashboard.minutesThisWeek')}`,
    ...
    },
    {
      ...
      subtitle: t('dashboard.quickCapture'),
      color: 'text-primary',
    ...
    },
    {
      ...
      subtitle: t('dashboard.trackSpending'),
      color: 'text-success',
    ...
    {
      icon: CheckCircle,
      title: t('dashboard.checkHabit'),
      subtitle: t('dashboard.buildStreak'),
