...
import splitzLogoWebp from '@/assets/splitz-logo.webp';
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (error) {
                      toast.error(t('errors.socialLoginFailed') || 'Google sign-in failed');
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (error) {
                      toast.error(t('errors.socialLoginFailed') || 'Apple sign-in failed');
