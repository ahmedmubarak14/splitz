...
const resources = {
  en: {
    translation: {
      ...
      paymentRecorded: "Payment recorded successfully",
      cycleAdvanced: "Cycle advanced to next period",
      ...
      currentContributors: 'Current Contributors',
        ...
        reminderMessage: 'Please settle your payment for',
        ...
        statusYourContribution: 'You - Unpaid',
  ...
  ar: {
    translation: {
      ...
      subscriptions: {
        ...
        splitConfiguration: 'إعداد التقسيم',
        people: 'أشخاص',
        description: 'الوصف',
